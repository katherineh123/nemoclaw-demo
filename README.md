...
| `setup_exec_demo.sh` | Fresh-VM setup/reset script for the NemoClaw executive demo. It installs dependencies, prompts for credentials, creates isolated OpenClaw sandboxes, and prints each executive's links. |
